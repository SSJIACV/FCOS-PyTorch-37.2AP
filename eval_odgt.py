...
val_odgt_now = Config_myself.val_odgt_now
det_save_odgt = Config_myself.det_save_odgt
det_save_eval_log_txt = Config_myself.det_save_eval_log_txt
threshold=0.05
CLASSES_NAME = Config_myself.CLASSES_NAME
# CLASSES_NAME = ["__background__ ","xianjia_good","xianjia_bad"]
# CLASSES_NAME = ["__background__ ","songduangu","yiwu"]
# CLASSES_NAME = ["__background__ ","good","zangwu"]
# CLASSES_NAME = ["__background__ ","jichu"]
# CLASSES_NAME = ["__background__ ","tongdao"]
# CLASSES_NAME = ['__background__ ','normal_board','bad_board','normal_driving_birds_device','bad_driving_birds_device']
resize_size=Config_myself.resize_size
weight_path = Config_myself.weight_path
VAL_IMGS = Config_myself.VAL_IMGS
VAL_GT = Config_myself.val_odgt_now
...
if __name__=="__main__":
    if os.path.exists(det_save_odgt):
        ...
        model=FCOSDetector(mode="inference",config=Config_myself)
